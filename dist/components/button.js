...
function Button({ className, variant = "default", size = "default", render, ...props }) {
    return (_jsx(ButtonPrimitive, { "data-slot": "button", className: cn(buttonVariants({ variant, size, className })), render: render, ...(render ? { nativeButton: false } : {}), ...props }));
}
